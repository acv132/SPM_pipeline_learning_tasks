...
for c=1:contrastOptions.whichCon
    ...
    results.matlabbatch{1}.spm.stats.results ...
        .conspec(1).titlestr = strjoin([title, string(spm.SPM.xCon(c).name), ...
        "with applied contrast mask:", contrastMask]);
    results.matlabbatch{1}.spm.stats.results ...
    ...
    if doImageMask
        results.matlabbatch{1}.spm.stats.results ...
            .conspec(2).titlestr = strjoin([title, string(spm.SPM.xCon(c).name), ...
            "(image mask)"]);
        results.matlabbatch{1}.spm.stats.results ...
        ...
        results.matlabbatch{1}.spm.stats.results ...
            .conspec(2).mask.image.name = cellstr(contrastOptions.applyImageAsMask);
        results.matlabbatch{1}.spm.stats.results ...
