function preprocess_OLA_R(subjects, fmri_data_path)
% PREPROCESS_OLA_R is a preprocessing function for the PL and OLA data (it
% combines all the other preprocessing functions since they do not differ
% in the configs)
% PREPROCESS_OLA_R(subjects, fmri_data_path) takes as the
