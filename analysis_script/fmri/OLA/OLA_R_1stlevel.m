function OLA_R_1stlevel(subjects, beh_data_path,fmri_data_path, ...
    firstlevel_data_path)
% OLA_R_1STLEVEL executes a GLM analysis of the Object Location Association
% Task as used by Kukolja et al. (2009);
% Onsets for all events: CORSCR, FALSCR, NEW, false NEW, FORGSCR, MISS are
% listed in OLA.mat in the individual behavioural data folder; only correct
% source judgement events are modelled;
% OLA_R_1STLEVEL(subjects,beh_data_path,fmri_data_path, ...
...
% $Author: A. Kasparbauer, A. Vorreuther $Date: 2022/04/26
arguments
    subjects (1,:) cell;
...
for i = 1:numel(subjects)
    ...
    if exist(beh_sbj_onsets)==2
       ...
       if ~exist(fullfile(output_dir, "SPM.mat"), "file") || isempty(dir(fullfile(fullfile(output_dir, "con*.nii"))))
            ...
            forg_items = OLA.OLD.FORGSCR.N;
            miss_items = OLA.OLD.MISSSCR.N + OLA.NEW.MISS.N;
            ...
            matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).name = 'CORSCR';
            matlabbatch{1}.spm.stats.fmri_spec.sess.cond(1).onset = OLA.OLD.CORSCR.Onsets;
            ...
            matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).name = 'FALSCR';
            matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).onset = OLA.OLD.FALSCR.Onsets;
            ...
            matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).name = 'NEW_COR';
            matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).onset = OLA.NEW.COR.Onsets;
            matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).duration = 0;
            matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).tmod = 1;
            ...
            if forg_items>0
                t=t+1;
                matlabbatch{1}.spm.stats.fmri_spec.sess.cond(t).name = 'FORGSCR';
            ...
            if OLA.NEW.FAL.N>0
                t = t+1;
                matlabbatch{1}.spm.stats.fmri_spec.sess.cond(t).name = 'NEW_FAL';
                matlabbatch{1}.spm.stats.fmri_spec.sess.cond(t).onset = OLA.NEW.FAL.Onsets;
                matlabbatch{1}.spm.stats.fmri_spec.sess.cond(t).duration = 0;
                matlabbatch{1}.spm.stats.fmri_spec.sess.cond(t).tmod = 1;
                matlabbatch{1}.spm.stats.fmri_spec.sess.cond(t).pmod = struct('name', {}, 'param', {}, 'poly', {});
            ...
            %% contrasts
            matlabbatch{3}.spm.stats.con.consess{1}.tcon.name = 'CORSCR';
            matlabbatch{3}.spm.stats.con.consess{1}.tcon.convec = 1;
            matlabbatch{3}.spm.stats.con.consess{1}.tcon.sessrep = 'none';
            matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'FALSCR';
            matlabbatch{3}.spm.stats.con.consess{2}.tcon.convec = [0 0 1];
            matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'none';
            matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'NEW_COR';
            matlabbatch{3}.spm.stats.con.consess{3}.tcon.convec = [0 0 0 0 1];
            matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'none';
            matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'OLDrecognized';
            matlabbatch{3}.spm.stats.con.consess{4}.tcon.convec = [1 0 1];
            matlabbatch{3}.spm.stats.con.consess{4}.tcon.sessrep = 'none';
            matlabbatch{3}.spm.stats.con.consess{5}.tcon.name = 'CORSCR-FALSCR';
            matlabbatch{3}.spm.stats.con.consess{5}.tcon.convec = [1 0 -1];
            matlabbatch{3}.spm.stats.con.consess{5}.tcon.sessrep = 'none';
            matlabbatch{3}.spm.stats.con.consess{6}.tcon.name = 'OLD-NEWCOR';
            matlabbatch{3}.spm.stats.con.consess{6}.tcon.convec = [0.5 0 0.5 0 -1];
            matlabbatch{3}.spm.stats.con.consess{6}.tcon.sessrep = 'none';

            if forg_items>0
                matlabbatch{3}.spm.stats.con.consess{7}.tcon.name = 'FORGSCR';
                matlabbatch{3}.spm.stats.con.consess{7}.tcon.convec = [0 0 0 0 0 0 1];
                matlabbatch{3}.spm.stats.con.consess{7}.tcon.sessrep = 'none';
                matlabbatch{3}.spm.stats.con.consess{8}.tcon.name = 'CORSR+FALSCR >FORG';
                matlabbatch{3}.spm.stats.con.consess{8}.tcon.convec = [0.5 0 0.5 0 0 0 -1];
                matlabbatch{3}.spm.stats.con.consess{8}.tcon.sessrep = 'none';
            end

            if OLA.NEW.FAL.N>0
                matlabbatch{3}.spm.stats.con.consess{9}.tcon.name = 'FAL_NEW';
                matlabbatch{3}.spm.stats.con.consess{9}.tcon.convec = [0 0 0 0 0 0 0 0 1];
...
writecell(problem_log, fullfile(fileparts(fmri_data_path), "OLA_R_1stlevel_problem_log.csv"));
end